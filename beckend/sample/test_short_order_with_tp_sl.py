...
def short_order_with_tp_sl():
    ...
    take_profit_price = str(round(current_price * 0.98, 4))  # 2% 낮게 익절
    stop_loss_price = str(round(current_price * 1.02, 4))    # 2% 높게 손절
...
if __name__ == '__main__':
    print("숏 포지션 주문 (익절/손절 포함):", short_order_with_tp_sl())